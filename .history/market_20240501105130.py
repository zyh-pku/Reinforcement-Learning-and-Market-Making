...
class MarketEnvironment:
    def __init__(self, dim_price_grid, bound_inventory, dim_action_ask_price, dim_action_buy_price, Delta):
        ...
        self.price_list = np.array(list(range(self.dim_price_grid+1))) # +1 is because we start from 0 and end at dim_price_grid
        self.Delta = Delta # time increment
        # dimension of the state space: S = S_X*S_Y
        # dim_price_grid is the number of price levels, and dim_inventory_grid is the number of inventory levels
