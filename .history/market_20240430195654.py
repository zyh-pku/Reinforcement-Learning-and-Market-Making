...
class MarketEnvironment:
    def __init__(self, dim_price_grid, bound_inventory, dim_action_ask_price, dim_action_buy_price, Delta):
        ...
        self.Delta_0 = 0.1
        self.phi = 0.1 # the parameter for penalty of inventory risk in the reward function
    ...
    def step(self, idx_ask_price, idx_buy_price, midprice_integer, inventory):
        ...
        reward = ( -midprice_integer*self.tick_size/2+idx_ask_price*self.tick_size )*ask_order_change + ( midprice_integer*self.tick_size/2-idx_buy_price*self.tick_size )*buy_order_change - self.phi*(inventory**2)*self.Delta + (midprice_next-midprice_integer)*inventory
