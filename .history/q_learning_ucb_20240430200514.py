...
class QLearningAgent:
    ...
    def __init__(self, env, dim_midprice_grid, dim_inventory_grid, dim_action_ask_price, dim_action_buy_price, Delta=0.1,  \
        ...
        # we now directly set the true value of self.V_star,self.ask_price_star,self.buy_price_star
        self.ask_price_star = np.array([[3., 2., 2.],[3., 2., 2.],[3., 2., 2.]])
        self.buy_price_star = np.array([[0., 0., 3.],[0., 0., 3.],[0., 0., 3.]])

        self.Delta_list = np.logspace(-1, -3, num=10)
        self.V_star_list = np.array([[[2.83121357, 2.98443247, 2.84898494],
                [2.85128162, 3.03007152, 2.85128162],
                [2.84898494, 2.98443247, 2.83121357]],

               [[2.62587854, 2.75837327, 2.65244455],
                [2.65497981, 2.79374967, 2.65497981],
                [2.65244455, 2.75837327, 2.62587854]],

               [[2.52984689, 2.65143627, 2.55850285],
                [2.56067249, 2.68216936, 2.56067249],
                [2.55850285, 2.65143627, 2.52984689]],

               [[2.47904758, 2.59462707, 2.50832543],
                [2.5102288 , 2.62305639, 2.5102288 ],
                [2.50832543, 2.59462707, 2.47904758]],

               [[2.45058316, 2.56274261, 2.48007205],
                [2.4818144 , 2.58993811, 2.4818144 ],
                [2.48007205, 2.56274261, 2.45058316]],

               [[2.43413089, 2.54430378, 2.4636985 ],
                [2.4653459 , 2.57080724, 2.4653459 ],
                [2.4636985 , 2.54430378, 2.43413089]],

               [[2.42442926, 2.53343366, 2.45402878],
                [2.45562015, 2.55953829, 2.45562015],
                [2.45402878, 2.53343366, 2.42442926]],

               [[2.41859134, 2.52690321, 2.44820486],
                [2.44976302, 2.55277427, 2.44976302],
                [2.44820486, 2.52690321, 2.41859134]],

               [[2.41495583, 2.52285536, 2.44457597],
                [2.44611436, 2.54858836, 2.44611436],
                [2.44457597, 2.52285536, 2.41495583]],

               [[2.4125166 , 2.52016996, 2.44214008],
                [2.44366669, 2.54582087, 2.44366669],
                [2.44214008, 2.52016996, 2.4125166 ]]])
        index_value = np.where(self.Delta_list==self.Delta)[0][0]
        self.V_star = self.V_star_list[index_value, :, :]
    ...
    def set_learning_rate(self, ):
        if self.UCB:
            ...
            learning_rate_schedule = [self.eps*1/((i+1)**self.eps_epoch) for i in range(self.N_learning_steps)]
    ...
    def update(self, ):
        ...
        for i in range(self.N_RL_iter):
            ###### compute the steps for V error small
